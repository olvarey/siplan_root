...
class Organizacion(models.Model):
    ...
    descripcion_organizacion = models.CharField(max_length=500, blank=True, null=True)
    mision_organizacion = models.CharField(max_length=500, blank=True, null=True)
    nombre_organizacion = models.CharField(max_length=500)
    vision_organizacion = models.CharField(max_length=500, blank=True, null=True)
...
class UnidadOrganizativa(models.Model):
    id_unidad_organizativa = models.BigAutoField(primary_key=True)
    nombre_unidad_organizativa = models.CharField(max_length=500)
    id_organizacion = models.ForeignKey(
        Organizacion, models.RESTRICT, db_column="id_organizacion"
    )
    id_unidad_superior = models.ForeignKey(
        "self", models.RESTRICT, db_column="id_unidad_superior", blank=True, null=True
    )
