# Generated by Django 4.1a1 on 2022-06-14 19:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id_tipo_objetivo",
                    models.ForeignKey(
                        db_column="id_tipo_objetivo",
                        on_delete=django.db.models.deletion.RESTRICT,
                        to="siplan.tipoobjetivo",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id_unidad_presupuestaria",
                    models.ForeignKey(
                        db_column="id_unidad_presupuestaria",
                        on_delete=django.db.models.deletion.RESTRICT,
                        to="siplan.unidadpresupuestaria",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                db_column="id_tipo_indicador",
                on_delete=django.db.models.deletion.RESTRICT,
                to="siplan.tipoindicador",
            ),
        ),
        migrations.AddField(
            model_name="indicador",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id_anio_resultado",
                    models.ForeignKey(
                        db_column="id_anio_resultado",
                        on_delete=django.db.models.deletion.RESTRICT,
                        to="siplan.anioresultado",
                    ),
                ),
                (
                    "id_financiamiento",
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.RESTRICT,
                        to="siplan.financiamiento",
                    ),
                ),
                (
                    "id_linea_trabajo",
                    models.ForeignKey(
                        db_column="id_linea_trabajo",
                        on_delete=django.db.models.deletion.RESTRICT,
                        to="siplan.lineatrabajo",
                    ),
                ),
            ],
            options={
